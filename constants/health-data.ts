...
function meals2(): Meal[] {
  return [
    {
      key: 'meal1', label: 'Meal 1', time: '12:00 PM', title: 'Grilled chicken + broccoli + black beans',
      items: [
        { name: 'Grilled chicken breast', portion: '8 oz', description: '8 oz boneless skinless chicken breast, grilled or baked, seasoned with garlic powder and black pepper',
          imageUrl: IMG.chicken, portionHint: 'About the size of your palm + fingers' },
        { name: 'Steamed broccoli + sautéed spinach', portion: '1 cup broccoli + 1 cup spinach', description: '1 cup steamed broccoli florets and 1 cup baby spinach wilted in a pan with lemon juice',
          imageUrl: IMG.vegetables, portionHint: 'Roughly two clenched fists total' },
        { name: 'Black beans', portion: '1 cup', description: '1 cup canned black beans (no salt added), drained and rinsed, heated through',
          imageUrl: IMG.beans, portionHint: 'One closed fist' },
        { name: 'Apple', portion: '1 medium', description: '1 medium Fuji or Gala apple, eaten whole with skin for the pectin fiber',
          imageUrl: IMG.fruit, portionHint: 'One whole apple' },
      ],
      drink: '16.9-24 oz water or sparkling water with the meal. Drink the full bottle before you leave the table.',
    },
    {
      key: 'meal2', label: 'Meal 2', time: '6:30 PM', title: 'Wild salmon + asparagus + purple cabbage salad',
      items: [
        { name: 'Baked wild salmon', portion: '8 oz', description: '8 oz wild salmon fillet, baked at 400°F for 12-15 min with lemon juice and Mrs. Dash',
          imageUrl: IMG.salmon, portionHint: 'About the size of your palm + fingers' },
        { name: 'Roasted asparagus + purple cabbage slaw', portion: '1 cup asparagus + 1 cup cabbage', description: '1 cup asparagus spears roasted at 425°F for 10 min with garlic powder, plus 1 cup raw purple cabbage shredded into a slaw with lemon juice',
          imageUrl: IMG.salad, portionHint: 'Fill half the plate with these two' },
        { name: 'Baked sweet potato', portion: '1 medium', description: '1 medium sweet potato, baked whole at 400°F for 45-50 min, eaten plain or with cinnamon',
          imageUrl: IMG.sweetPotato, portionHint: 'About the size of your fist' },
        { name: 'Fat-free Greek yogurt with cinnamon', portion: '1 cup', description: '1 cup plain fat-free Greek yogurt topped with a shake of ground cinnamon. Only if hunger is still loud after the main plate.',
          imageUrl: IMG.yogurt, portionHint: 'Only if you actually need it' },
      ],
      drink: '16.9-24 oz water or unsweet green tea. Finish before you leave the kitchen.',
    },
  ];
}
...
function meals4(): Meal[] {
  return [
    {
      key: 'meal1', label: 'Meal 1', time: '8:30 AM', title: 'Egg whites + blueberries',
      items: [
        { name: 'Scrambled egg whites', portion: '1 cup', description: '1 cup liquid egg whites, scrambled in a non-stick pan with black pepper. No oil, no butter.',
          imageUrl: IMG.eggWhites, portionHint: 'About the size of a small coffee cup' },
        { name: 'Fresh blueberries', portion: '1 cup', description: '1 cup fresh or frozen blueberries — lowest glycemic berry, best for your A1c and LDL',
          imageUrl: IMG.blueberries, portionHint: 'One cupped hand' },
        { name: 'Psyllium in water', portion: '1 serving', description: '1 tablespoon psyllium husk powder stirred into a full 16 oz glass of water. Only if your doctor has approved it.',
          imageUrl: IMG.psyllium, portionHint: 'Stir into a full glass, drink immediately before it thickens' },
      ],
      drink: '16.9 oz water. Drink the whole bottle with breakfast. The early bottle makes the total day much easier.',
    },
    {
      key: 'meal2', label: 'Meal 2', time: '12:30 PM', title: 'Grilled chicken + broccoli + lentils',
      items: [
        { name: 'Grilled chicken breast', portion: '6-7 oz', description: '6-7 oz boneless skinless chicken breast, grilled or baked, seasoned with garlic powder, onion powder, and black pepper',
          imageUrl: IMG.chicken, portionHint: 'Size of your palm' },
        { name: 'Steamed broccoli + green beans', portion: '1 cup broccoli + 1 cup green beans', description: '1 cup steamed broccoli florets and 1 cup steamed or sautéed green beans with lemon juice',
          imageUrl: IMG.vegetables, portionHint: 'Roughly two clenched fists total' },
        { name: 'Cooked lentils', portion: '3/4 cup', description: '3/4 cup cooked green or brown lentils, seasoned with garlic powder and black pepper',
          imageUrl: IMG.beans, portionHint: 'Just under one closed fist' },
      ],
      drink: '16.9-20 oz water or sparkling water. Drink the full bottle with lunch.',
    },
    {
      key: 'meal3', label: 'Meal 3', time: '4:00 PM', title: 'Sardines + apple + carrot sticks',
      items: [
        { name: 'Canned sardines in water', portion: '1 can (4 oz)', description: '1 can sardines packed in water, drained. Eat straight from the can or on a plate with lemon juice and black pepper.',
          imageUrl: IMG.sardines, portionHint: 'One small can, drained' },
        { name: 'Apple', portion: '1 medium', description: '1 medium apple (Fuji or Gala), eaten whole with skin. The pectin fiber binds cholesterol.',
          imageUrl: IMG.fruit, portionHint: 'One whole apple' },
      ],
      drink: '12-16 oz water or unsweet green tea. This is the bridge — it keeps you from mauling dinner.',
    },
    {
      key: 'meal4', label: 'Meal 4', time: '7:30 PM', title: 'Baked salmon + asparagus + purple cabbage slaw',
      items: [
        { name: 'Baked wild salmon', portion: '6-8 oz', description: '6-8 oz wild salmon fillet, baked at 400°F for 12-15 min with lemon juice, garlic powder, and Mrs. Dash',
          imageUrl: IMG.salmon, portionHint: 'Size of your palm + fingers' },
        { name: 'Roasted asparagus + purple cabbage slaw', portion: '1 cup asparagus + 1 cup cabbage', description: '1 cup asparagus spears roasted at 425°F for 10 min, plus 1 cup shredded purple cabbage dressed with lemon juice and black pepper',
          imageUrl: IMG.salad, portionHint: 'Fill half the plate with these two' },
        { name: 'Baked sweet potato', portion: '1 small', description: '1 small sweet potato, baked at 400°F for 40 min. Only if you are genuinely still hungry after the protein and vegetables.',
          imageUrl: IMG.sweetPotato, portionHint: 'Only if you genuinely still need it' },
      ],
      drink: '16.9-20 oz water. Finish the daily quota here. Not with snacks later.',
    },
  ];
}
